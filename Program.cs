    ...
    class Program
    {
        ...
        private static void FileSystemWatcher_Created1(object sender, System.IO.FileSystemEventArgs e)
        {
            ...
            if(File.Exists(json))
            {
               ...
               // Console.WriteLine("This is the contents of the json file:  \n\n\n\n\n\n" + compressionQuality + colorImageCompression + colorImageFilter + colorImageLayers + colorImagePrecision + compressPDFobjects);
